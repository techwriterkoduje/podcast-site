...
export default function LatestEpisodes() {
    return (
        <Stack sx={{justifyContent: "center", margin: "auto", gap: "2rem", width: "1200px"}}>
            ...
            <Stack direction="row" sx={{gap: "1rem", margin: "auto", width: "100%"}}>
                <Card sx={{width: "100%"}}>
                    <iframe
            ...
            <Link href="/episode-list">
                <Button variant="contained" sx={{width: "50%", margin: "auto"}}>Wszystkie odcinki</Button>
            </Link>
        </Stack>
    )
}